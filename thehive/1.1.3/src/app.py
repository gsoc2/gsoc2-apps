...
class TheHive(AppBase):
    ...
    def get_item(self, apikey, url, organisation, field_type, cur_id):
        ...
        if field_type.lower() == "alert":
            ...
            return (
                "%s is not implemented. See https://github.com/gsoc2/gsoc2-apps for more info."
                % field_type
            )
    ...
    def update_field(
        ...
        if field_type.lower() == "alert":
            ...
            return (
                "%s is not implemented. See https://github.com/gsoc2/walkoff-integrations for more info."
                % field_type
            )
