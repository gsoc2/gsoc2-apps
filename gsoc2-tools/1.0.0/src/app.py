...
class Tools(AppBase):
    ...
    def send_email_gsoc2(self, apikey, recipients, subject, body):
        targets = [recipients]
        if ", " in recipients:
    ...
    def execute_python(self, code, gsoc2_input):
        print("Run with gsoc2_data %s" % gsoc2_input)
        ...
        return "Some return: %s" % gsoc2_input
