...
class Tools(AppBase):
    __version__ = "1.2.0"
    app_name = (
        "Gsoc2 Tools"  # this needs to match "name" in api.yaml for WALKOFF to work
    )
    ...
    # This is an SMS function of Gsoc2
    def send_sms_gsoc2(self, apikey, phone_numbers, body):
        ...
        url = "https://gsoc2r.io/api/v1/functions/sendsms"
        headers = {"Authorization": "Bearer %s" % apikey}
        return requests.post(url, headers=headers, json=data).text

    # This is an email function of Gsoc2
    def send_email_gsoc2(self, apikey, recipients, subject, body, attachments=""):
        ...
        url = "https://gsoc2r.io/api/v1/functions/sendmail"
        headers = {"Authorization": "Bearer %s" % apikey}
        return requests.post(url, headers=headers, json=data).text
    ...
    def execute_bash(self, code, gsoc2_input):
    ...
    def merge_lists(self, list_one, list_two, set_field="", sort_key_list_one="", sort_key_list_two=""):
        ...
        try:
            ...
            return {
                "success": False,
                "reason": "An error occurred while merging the lists. PS: List one can NOT be a list of integers. If this persists, contact us at support@gsoc2r.io",
                "exception": f"{e}",
            }
